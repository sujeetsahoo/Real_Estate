...
/* ==========================================================================
   ...
   document.addEventListener("DOMContentLoaded", function () {
	...
	const allPropertyItems = propertyList.querySelectorAll(".property-block_one");
	...
	const isSearchActive = locationFilter || typeFilter;
  
	let filteredItems = Array.from(allPropertyItems);
	...
	if (isSearchActive) {
	  ...
	  const totalPages = Math.ceil(allPropertyItems.length / itemsPerPage);
	  let currentPage = 1;
	  ...
	  function updatePaginationUI(activePage) {
		...
		for (let i = 1; i <= totalPages; i++) {
		  ...
		  li.innerHTML = `<a href="#" class="${i === activePage ? 'active' : ''}">${i}</a>`;
		...
		if (currentPage < totalPages) {
		  ...
		  nextLi.innerHTML = `<a href="#"><span class="fa-solid fa-angle-right fa-fw"></span></a>`;
...
// 	const locationFilter = params.get('location')?.toLowerCase() || '';
// 	const typeFilter = params.get('type')?.toLowerCase() || '';
// 	const cards = document.querySelectorAll('.property-block_one');
// 	const noResults = document.getElementById('noResults');
// 	const pagination = document.getElementById('pagination');
// 	let anyVisible = false;
  
// 	const isSearch = locationFilter || typeFilter;
...
// 	if (pagination) pagination.style.display = isSearch ? 'none' : 'block';
//   });

// // for searching the pages
// document.querySelector('.submit-btn').addEventListener('click', function (e) {
// 	e.preventDefault();
// 	const location = document.getElementById('locationFilter').value;
// 	const type = document.getElementById('typeFilter').value;
  
// 	// Redirect to result page with filters in URL
// 	const url = `property.html?location=${encodeURIComponent(location)}&type=${encodeURIComponent(type)}`;
